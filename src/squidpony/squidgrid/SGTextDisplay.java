...
public interface SGTextDisplay extends SGDisplay{
     ...
     * to allow all of the characters to take up the same amount of space. 
     * 
     * The font size in the passed in Font will be ignored and a size that best matches the
     * requested cell dimension will be used.
     *
    ...
    /**
     * Initializes the component with the supplied number of rows and columns. The size
     * of the display will be adjusted to match the requested font size as closely as
     * possible.
     *
     ...
     * the grid spaces.
     * 
     * If whiteSpace is true, then every character is guaranteed to have at least
     * one pixel between it and the edge of the cell. If false, some characters
     * might sit against the edge of the cell, but will not be cropped.
     * 
    ...
    /**
     * Sets one specific block to the given character. This is far more efficient if
